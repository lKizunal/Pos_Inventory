...
<form action="" id="manage-user" autocomplete="off">
		...
		<div class="form-group">
			<label for="celnum">Cel/Tel No.</label>
			<input type="text" name="celnum" id="celnum" class="form-control" value="<?php echo isset($meta['celnum']) ? $meta['celnum']: '' ?>" required>
		</div>
		<div class="form-group">
...
<script>
	$('#manage-user').submit(function(e){
		...
		start_load()
		$.ajax({
			url:'./admin_class.php?a=save_user',
			method:'POST',
			data:$(this).serialize(),
