...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			...
			<form action="" id="manage-supplier" autocomplete="off">
				<div class="card">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a class="edit_supplier" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['supplier_name'] ?>" data-contact="<?php echo $row['contact'] ?>" data-address="<?php echo $row['address'] ?>" >Edit</a>
...
<script>
	...
	$('#manage-supplier').submit(function(e){
		...
		start_load()
		$.ajax({
			url:'./admin_class.php?a=save_supplier',
	...
	function delete_supplier($id){
		start_load()
		$.ajax({
			url:'./admin_class.php?a=delete_supplier',
			method:'POST',
			data:{id:$id},
			success:function(resp){
				if(resp==1){
